...
/**----------------------
    ...
    advanceArrows("citrus_petco_hills_bp_tab_products");
    ...
    document.addEventListener("DOMContentLoaded", function () {
        filterProducts("citrus_petco_hills_bp_tab_products");
    });
    // for dog filter function
    function filterProducts(c) {
        var x, i;
        x = document.getElementsByClassName("citrus_petco_hills_bp__Product");
        if (c == "all") c = "";
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        var dogBtnContainer = document.getElementById("citrus_petco_hills_bpTabId");
        var dogBtns = dogBtnContainer.getElementsByClassName("citrus_petco_hills_bp__tab_item");
        addActiveClass(dogBtns, "citrus_petco_hills_bp__active_tab");
    });
